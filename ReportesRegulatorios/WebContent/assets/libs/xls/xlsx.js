...
if(typeof module !== "undefined" && typeof require !== 'undefined') {
	if(typeof cptable === 'undefined') cptable = require('assets/libs/xls/dist/cpexcel');
...
function CheckField(hexstr, fld) {
	...
	if(m !== hexstr){
		showError("Libreria no cargada correctamente. La página se actualizara automáticamente");
		$("#EditarError").click();
